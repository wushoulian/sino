...
<tr>
    <td align="left" style="vertical-align: text-bottom"><img src="plug-in/login/images/logo.png">
	        <div style="position: absolute; top: 75px; left: 33px;">LINYI SINO GOLF <span style="letter-spacing: -1px;">CO.,LTD</span></div>
    </td>
