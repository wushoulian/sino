...
<html>
<head>
<title>LINYI SINO GOLF CO.,LTD</title>
...
<!-- 顶部-->
<div region="north" border="false" title="临沂顺亿高尔夫球制品有限公司" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
    <td align="left" style="vertical-align: text-bottom;"><img src="plug-in/login/images/logo.png;"></td>
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #CC99FF; padding-top: 2px">&copy;
       <t:mutiLang langKey="common.copyright"/>
        <span class="tip">
            <a href="http://www.sinogolf.com" title=" 临沂顺亿高尔夫球制品有限公司"> SINO GOLF CO.,LTD</a>
        </span>
    </div>
</div>
